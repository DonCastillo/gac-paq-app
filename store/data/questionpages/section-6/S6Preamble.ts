...
const S6Preamble: LangPreamblePayloadInterface = {
	...
	translations: {
		...
		"es-CO": {
			...
			description: {
				kid: "Esto incluye toda la actividad física que realizas durante tu tiempo de juego o tiempo libre. No incluye las actividades organizadas ni los recreos en la escuela.\n\nPara las siguientes preguntas, NO incluyas las actividades que acabas de informar.",
				adult:
					"Esto incluye toda la actividad física que realizas durante tu tiempo de juego o tiempo libre. No incluye las actividades organizadas ni los recreos en la escuela.\n\nPara las siguientes preguntas, NO incluyas las actividades que acabas de informar.",
			},
		},
		"es-CL": {
			heading: "Juego o tiempo libre",
