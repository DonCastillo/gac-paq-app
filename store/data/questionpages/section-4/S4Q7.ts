...
const S4Q7: LangQuestionCheckboxPayloadInterface = {
	...
	translations: {
		...
		"hi-IN": {
			...
			heading: "प्रश्न १७",
			label:
				"पिछले सप्ताह में, क्या आप स्कूल या काम के अलावा अन्य स्थानों (उदाहरण के लिए, किसी मित्र का घर, कोई पार्क, कोई दुकान) पर जाने के लिए पैदल या व्हीलिंग करके गए थे?",
			kid_label:
				"पिछले सप्ताह में, क्या आप स्कूल या काम के अलावा अन्य स्थानों (उदाहरण के लिए, किसी मित्र का घर, कोई पार्क, कोई दुकान) पर जाने के लिए पैदल या व्हीलिंग करके गए थे?",
			adult_label:
