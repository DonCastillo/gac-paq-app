...
const S4Q8: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"hi-IN": {
			...
			label:
				"पिछले सप्ताह में आप स्कूल या काम के अलावा अन्य स्थानों पर जाने के लिए कितने दिन पैदल गए?",
			kid_label:
				"पिछले सप्ताह में आप स्कूल या काम के अलावा अन्य स्थानों पर जाने के लिए कितने दिन पैदल गए?",
			adult_label:
				"पिछले सप्ताह में आपका बच्चा स्कूल या काम के अलावा अन्य स्थानों पर जाने के लिए कितने दिन पैदल गया?",
			choices: [
				{
					label: "1 दिन",
					value: "1",
