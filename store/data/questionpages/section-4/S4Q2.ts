...
const S4Q2: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"en-NZ": {
			type: Question.QuestionRadio,
			heading: "Question 15b",
			label: "How many days did you use this mode to go to school in the past week?",
			kid_label: "How many days did you use this mode to go to school in the past week?",
			adult_label: "How many days did your child use this mode for school in the past week? ",
			choices: [
				{
					label: "1 day",
					value: "1",
		...
		"hi-IN": {
			type: Question.QuestionRadio,
			heading: "प्रश्न १५b",
			label: "पिछले सप्ताह आपने कितने दिन इस साधन का उपयोग किया?",
			kid_label: "पिछले सप्ताह आपने कितने दिन इस साधन का उपयोग किया?",
			adult_label: "आपके बच्चे ने पिछले सप्ताह में कितने दिन इस साधन का उपयोग किया?",
			choices: [
				{
					label: "1 दिन",
					value: "1",
