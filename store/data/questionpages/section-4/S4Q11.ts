	...
	translations: {
		...
		"hi-IN": {
			...
			kid_label:
				"एक सामान्य दिन में, आप स्कूल या नौकरी के अलावा अन्य स्थानों पर जाने के लिए कितना समय व्हीलिंग करके गए?",
			adult_label:
				"एक सामान्य दिन में, आपका बच्चा स्कूल या नौकरी के अलावा अन्य स्थानों पर जाने के लिए कितना समय व्हीलिंग करके गया?",
			choices: [
				{
		...
		"th-TH": {
			...
			heading: "ข้อ 17c - ล้อ",
			label:
				"ในวันปกติ คุณใช้เวลาเท่าไหร่ในการใช้อุปกรณ์หรือรถที่มีล้อ หรือล้อเลื่อนที่ใช้การออกแรงของร่างกายไปยังสถานที่อื่นที่ไม่ใช่โรงเรียนหรือที่ทำงาน?",
			kid_label:
				"ในวันปกติ คุณใช้เวลาเท่าไหร่ในการใช้อุปกรณ์หรือรถที่มีล้อ หรือล้อเลื่อนที่ใช้การออกแรงของร่างกายไปยังสถานที่อื่นที่ไม่ใช่โรงเรียนหรือที่ทำงาน?",
			adult_label:
				"ในวันปกติ บุตรหลานของคุณใช้เวลาเท่าไหร่ในการใช้อุปกรณ์หรือรถที่มีล้อ หรือล้อเลื่อนที่ใช้การออกแรงของร่างกายไปยังสถานที่อื่นที่ไม่ใช่โรงเรียนหรือที่ทำงาน?",
			choices: [
				{
