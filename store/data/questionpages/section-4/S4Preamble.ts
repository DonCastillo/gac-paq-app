...
const S4Preamble: LangPreamblePayloadInterface = {
	...
	translations: {
		...
		"cz-CR": {
			...
			subheading: "Sekce 4",
			description: {
				kid: "Tato část je o dopravě.",
				adult: "Tato část je o dopravě vašeho dítěte.",
			},
		},
		"es-CO": {
			heading: "Transporte",
		...
		"ma-IN": {
			...
			subheading: "विभाग ४",
			description: {
				kid: "तुम्ही वेगवेगळ्या ठिकाणी जाताना कसा प्रवास करता याविषयी हा विभाग आहे.",
				adult: "तुमचे मूल वेगवेगळ्या ठिकाणी जाताना कसा प्रवास करते याविषयी हा विभाग आहे.",
			},
		},
		"hi-IN": {
			heading: "परिवहन",
