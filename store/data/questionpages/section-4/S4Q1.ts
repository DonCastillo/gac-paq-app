	...
	translations: [
		{
			...
			kid_label: "How did you go to school in the past week? (Select the mode that you used the most).",
			adult_label: "How did your child go to school in the past week? (Select the mode that your child used the most).",
			choices: [
				{
					text: "Walking",
					value: "Walking",
