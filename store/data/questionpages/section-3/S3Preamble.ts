...
const S3Preamble: LangPreamblePayloadInterface = {
	...
	translations: {
		...
		"hi-IN": {
			...
			subheading: "भाग 3",
			description: {
				kid: "यह अनुभाग आपके घर से दूर काम या स्वयंसेवा के बारे में है - घरेलू कामकाज से अलग। काम करना तब होता है जब आप अपने या अपने परिवार के लिए पैसे कमाते हैं। स्वयंसेवा का मतलब है दूसरों या किसी संगठन की मुफ़्त में मदद करना (बिना पैसे के)। काम और स्वयंसेवा किसी स्टोर, खेत, रेस्टोरेंट आदि जैसे स्थानों पर हो सकते हैं। कृपया दोनों का एक साथ उत्तर दें।",
				adult:
					"यह अनुभाग आपके घर से दूर काम या स्वयंसेवा के बारे में है - घरेलू कामकाज से अलग। काम करना तब होता है जब आपका बच्चा अपने या अपने परिवार के लिए पैसा कमा रहा हो। स्वयंसेवा का मतलब है दूसरों या किसी संगठन की मुफ़्त में मदद करना (बिना पैसे के)। काम और स्वयंसेवा किसी स्टोर, खेत, रेस्टोरेंट आदि जैसे स्थानों पर हो सकते हैं। कृपया दोनों का एक साथ उत्तर दें।",
			},
		},
		"en-AE": {
			heading: "Work",
