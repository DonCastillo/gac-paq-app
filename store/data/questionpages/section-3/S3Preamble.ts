	...
	translations: {
		...
		"ar-AE": {
			...
			description: {
				...
				adult:
					"يحتوي هذا القسم على أسئلة حول أعمال تطوعية أو وظائف خارج المنزل – هذا يختلف عن الأعمال المنزلية. الوظيفة قد تكون أي عمل تكتسب مقابلها دفعة مالية (راتب). أما العمل التطوعي عبارة عن مساعدة الآخرين أو منظمةٍ ما مجاناً (من دون مقابل مالي). يرجى الإجابة عن كلا النوعين من العمل معاً في الأسئلة التالية.",
			},
		},
		"ne-NP": {
			heading: "काम",
