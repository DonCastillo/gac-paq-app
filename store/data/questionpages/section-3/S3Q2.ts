...
const S3Q2: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"hi-IN": {
			type: Question.QuestionRadio,
			heading: "प्रश्न १३",
			label: "पिछले सप्ताह में, आपने स्वयंसेवा और/ या काम में कितने घंटे बिताए हैं?",
			kid_label: "पिछले सप्ताह में, आपने स्वयंसेवा और/ या काम में कितने घंटे बिताए हैं?",
			adult_label: "पिछले सप्ताह में, आपके बच्चे ने स्वयंसेवा और/या काम में कितने घंटे बिताए?",
			choices: [
				{
