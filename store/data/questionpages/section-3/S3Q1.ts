...
const S3Q1: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"hi-IN": {
			type: Question.QuestionRadio,
			heading: "प्रश्न १२",
			label: "पिछले सप्ताह में, क्या आपने स्वयंसेवा की या काम किया?",
			kid_label: "पिछले सप्ताह में, क्या आपने स्वयंसेवा की या काम किया?",
			adult_label: "पिछले सप्ताह में, क्या आपके बच्चे ने स्वयंसेवा की या काम किया?",
			choices: [
				{
					label: "हाँ",
					value: "yes",
