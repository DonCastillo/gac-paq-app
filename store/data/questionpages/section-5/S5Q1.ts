...
const S5Q1: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"en-NZ": {
			...
			label: "Did you do any organized activities during the past week?",
			kid_label: "Did you do any organized activities during the past week?",
			adult_label: "Did your child do any organised activities during the past week?",
			choices: [
				{
					label: "Yes",
					value: "yes",
		...
		"ar-AE": {
			type: Question.QuestionRadio,
			heading: "سؤال [١٨]",
			label: "هل شاركت في أي أنشطة منظمة أو خارجية خلال الأسبوع الماضي؟",
			kid_label: "هل شاركت في أي أنشطة منظمة أو خارجية خلال الأسبوع الماضي؟",
