...
const S5Preamble: LangPreamblePayloadInterface = {
	...
	translations: {
		...
		"mi-NZ": {
			...
			description: {
				kid: "E hāngai ana tēnei wāhanga ki ngā ngohe whakakori tinana me ngā hākinakina kua whakaritea. Ko ngā hākinakina ēnei e kītea ana ki waho i te rā o te kura (Hei tauira, he hākinakina, he mahi marau-turuki ō ētahi kura). Ka tāpiri hoki ki ngā hākinakina me ngā ngohe pēnei i te kauhoe, i te takaporepore, i te kanikani me ngā toi whawhai i waho i te kura.",
				adult:
					"E hāngai ana tēnei wāhanga ki ngā ngohe whakakori tinana me ngā hākinakina kua whakaritea. Ko ngā hākinakina ēnei e kītea ana ki waho i te wā kura (Hei tauira, he hākinakina, he mahi marau-turuki ō ētahi kura). Ka tāpiri hoki ki ngā hākinakina me ngā ngohe pēnei i te kauhoe, i te takaporepore, i te kanikani me ngā toi whawhai i waho i te kura.",
			},
		},
		"en-NZ": {
			heading: "Organized Activities",
		...
		"es-CO": {
			...
			description: {
				kid: "Esta sección trata de las actividades organizadas físicamente activas y los deportes. Incluyen actividades que realizas después del colegio (por ejemplo, algunos colegios tienen ligas deportivas o actividades extraescolares). También se incluyen las ligas deportivas y las clases de actividades como natación, gimnasia, danza y kárate fuera del colegio.",
				adult:
		...
		"ar-AE": {
			heading: "الأنشطة المنظّمة",
			subheading: "القسم الخامس [٥]",
			description: {
				kid: "يحتوي هذا القسم على أسئلة حول الأنشطة المنظّمة والرياضة، وهي تشمل الأنشطة التي تقوم بها خارج المدرسة (مثل البطولات الرياضية أو الأنشطة التي تقدمها بعض المدارس). وتشمل أيضاً أي دوريات رياضية أو دروس السباحة والجمباز والكاراتيه وركوب الخيل وغيرها.",
				adult:
					"يحتوي هذا القسم على أسئلة حول الأنشطة المنظمّة والرياضة، وهي تشمل الأنشطة التي يقوم بها طفلك خارج المدرسة (مثل البطولات الرياضية أو الأنشطة التي تقدمها بعض المدارس). وتشمل أيضاً أي دوريات رياضية أو دروس السباحة والجمباز والكاراتيه وركوب الخيل وغيرها.",
			},
		},
		"ne-NP": {
		...
		"pt-BR": {
			...
			description: {
				...
				adult:
					"Esta seção trata de atividades físicas organizadas e esportes. Elas incluem atividades que a criança ou adolescente que você é responsável pratica fora do horário escolar. Por exemplo, algumas escolas têm escolinhas de treinamento, ligas esportivas ou atividades extracurriculares. Essas atividades também incluem aulas de natação, ginástica, dança, karatê, judô e outras artes marciais fora da escola.",
			},
		},
		"sv-SE": {
