	...
	translations: {
		...
		"hi-IN": {
			...
			description: {
				...
				adult:
					"यह अनुभाग उस समय के बारे में है जो आपका बच्चा बाहर बिताता है। यह स्कूल में, कामकाज के दौरान, काम और स्वयंसेवा, और परिवहन के साथ-साथ उनके खाली समय में भी हो सकता है। इसमें वह समय भी शामिल है जब आपका बच्चा बाहर है, लेकिन घूम नहीं रहा है (उदाहरण के लिए, पिकनिक, पढ़ना, आग के पास बैठना)।",
			},
		},
		"en-AE": {
			heading: "Outdoors",
