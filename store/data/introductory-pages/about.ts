...
const AboutPage: LangPagePayloadInterface = {
	...
	translations: {
		...
		"zh-CN": {
			heading: "欢迎填写全球儿童青少年身体活动调查问卷",
			description: "",
			description_mode: {
				kid: "本调查希望了解过去一周（包括上学日和周末）你的身体活动情况。\n\n你在很多时候都可以进行身体活动, 包括空闲时、运动时、玩耍时、去某些地方（如学校、公园、商店和朋友或亲戚家) 时、在学校时、做家务时和工作时。本应用将会对每种情境下发生的身体活动进行逐一说明，以引导你回答相对应的问题。\n\n我们将会问你关于参与不同强度身体活动的情况。当我们提到“中等或高强度”时, 指的是会让你心跳加快并且呼吸急促、上气不接下气的活动。[应用中展示的示例可能包括足球、游泳、跑步、跳绳、滑冰、越野滑雪、举重训练或骑自行车等]。\n\n当我们提到“低强度”时, 指的是没有让你呼吸急促、上气不接下气的活动。应用中展示的示例可能包括慢走、养宠物或家畜、玩沙子和做家务等。 \n\n所有问题的答案没有对错之分, 请选择最符合你的答案。",
				adult:
					"本调查希望了解过去一周（包括上学日和周末）您的孩子的身体活动情况。\n\n您的孩子在很多时候都可以进行身体活动, 包括空闲时、运动时、玩耍时、去某些地方 (如学校、公园、商店和朋友或亲戚家) 时、在学校时、做家务时和工作时。本应用将会对每种情境下发生的身体活动进行逐一说明，以引导您回答相对应的问题。 \n\n我们将会问您关于您的孩子的不同强度身体活动的情况。当我们提到“中等或高强度”时, 指的是会让您的孩子心跳加快并且呼吸急促、上气不接下气的活动。[应用中展示的示例可能包括足球、游泳、跑步、跳绳、滑冰、越野滑雪、举重训练或骑自行车。] \n\n当我们提到“低强度”时, 指的是没有让您的孩子呼吸急促、上气不接下气的活动。应用中展示的示例可能包括慢走、养宠物或家畜、玩沙子和做家务等。\n\n所有问题的答案没有对错之分, 请选择最符合你的答案。",
			},
		},
		"fr-CA": {
