...
const GSHS2: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"hi-IN": {
			...
			heading: "प्रश्न 26",
			label:
				"पिछले 7 दिनों के दौरान, आपने कितने दिनों में अपनी मांसपेशियों को मजबूत करने या टोन करने के लिए व्यायाम किया, जैसे पुश-अप, उठक-बैठक या भार उठाना ?",
			kid_label:
				"पिछले 7 दिनों के दौरान, आपने कितने दिनों में अपनी मांसपेशियों को मजबूत करने या टोन करने के लिए व्यायाम किया, जैसे पुश-अप, उठक-बैठक या भार उठाना ?",
			adult_label:
				"पिछले 7 दिनों के दौरान, आपने कितने दिनों में अपनी मांसपेशियों को मजबूत करने या टोन करने के लिए व्यायाम किया, जैसे पुश-अप, उठक-बैठक या भार उठाना ?",
		...
		"ch-MW": {
			...
			heading: "Funso 26",
			label:
				"M'masiku 7 apitawa, ndi masiku angati omwe munachita masewero olimbitsa thupi kuti mulimbitse minofu ya thupi lanu, monga kupanga ma push-up, ndi kunyamula ma weti kapena zitsulo?",
			kid_label:
				"M'masiku 7 apitawa, ndi masiku angati omwe munachita masewero olimbitsa thupi kuti mulimbitse minofu ya thupi lanu, monga kupanga ma push-up, ndi kunyamula ma weti kapena zitsulo?",
			adult_label:
				"M'masiku 7 apitawa, ndi masiku angati omwe munachita masewero olimbitsa thupi kuti mulimbitse minofu ya thupi lanu, monga kupanga ma push-up, ndi kunyamula ma weti kapena zitsulo?",
			choices: [
				{
					label: "Simunapangeko masewerowa",
					value: "0",
				},
				{
					label: "Tsiku limodzi",
