...
const GSHS5: LangQuestionRadioPayloadInterface = {
	...
	translations: {
		...
		"th-TH": {
			...
			heading: "ข้อ 29",
			label:
				"โดยปกติในแต่ละวันในการนั่งดูโทรทัศน์  นั่งเล ่นเกมคอมพิวเตอร์  นั่งท�างานโดยใช้โซเชี่ยลเนตเวิร์คนั่งคุยกับเพื่อน นั่งอ่านหนังสือ หรือนั่งคุยโทรศัพท์ฯลฯ นักเรียนใช้เวลาเท่าไร",
			kid_label:
				"โดยปกติในแต่ละวันในการนั่งดูโทรทัศน์  นั่งเล ่นเกมคอมพิวเตอร์  นั่งท�างานโดยใช้โซเชี่ยลเนตเวิร์คนั่งคุยกับเพื่อน นั่งอ่านหนังสือ หรือนั่งคุยโทรศัพท์ฯลฯ นักเรียนใช้เวลาเท่าไร",
			adult_label:
				"โดยปกติในแต่ละวันในการนั่งดูโทรทัศน์  นั่งเล ่นเกมคอมพิวเตอร์  นั่งท�างานโดยใช้โซเชี่ยลเนตเวิร์คนั่งคุยกับเพื่อน นั่งอ่านหนังสือ หรือนั่งคุยโทรศัพท์ฯลฯ นักเรียนใช้เวลาเท่าไร",
