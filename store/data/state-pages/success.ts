...
const SuccessPage: LangPagePayloadInterface = {
	...
	translations: {
		...
		"cz-CR": {
			heading: "Úspěch!",
			description:
				"Dobrá práce, dokončili jste dotazník. Vaše odpovědi byly úspěšně odeslány.\n\nDěkujeme za vaši pomoc!",
		},
		"es-CO": {
			heading: "Éxito!",
			description:
		...
		"ma-IN": {
			heading: "यश!",
			description:
				"खूप छान, तुम्ही प्रश्नावली पूर्ण केली. तुमची उत्तरे यशस्वीरित्या पाठवली गेली आहेत. तुमच्या मदतीबद्दल धन्यवाद!",
		},
		"hi-IN": {
			heading: "सफलता!",
			description:
				"बहुत अच्छा! आपने प्रश्नावली पूरी कर ली है। आपके जवाब भेज दिए गए हैं। आपकी मदद के लिए धन्यवाद!",
		},
		"en-AE": {
			heading: "Success!",
			description:
		...
		"ar-AE": {
			heading: "تمَّ بنجاح!",
			description: "أحسنت، لقد أنهيت من الاستبيان. تم إرسال إجاباتك بنجاح. شكراً لمساعدتك!",
		},
		"ne-NP": {
			heading: "सफल भयो !",
			description:
