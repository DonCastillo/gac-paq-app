...
export type AddPageFuncType = (state: SettingsInterface, action: PayloadAction<{ key: number; page: PageIndexInterface }>) => void;
export type SetPageFuncType = (state: SettingsInterface, action: PayloadAction<Record<number, PageIndexInterface>>) => void;
