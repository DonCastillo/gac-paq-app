...
const blackListLanguages = ["ne-NP", "pt-BR", "sv-SE", "th-TH", "zh-CN", "es-ES", "es-MX", "fr-CA", "ar-AE"];

const getImageBackground = (): any | null => {
	const blackListLanguages = ["ne-NP", "sv-SE", "th-TH", "zh-CN", "fr-CA", "ar-AE"];
...
const getOptionImage = (image_ident: string): any | null => {
	const blackListLanguages = ["sv-SE", "th-TH", "zh-CN", "fr-CA", "ne-NP", "ar-AE"];
	const settings = store.getState().settings;
